...
Device::Device(VkPhysicalDevice _physical)
{
	physical = _physical;
}
	
Device::Device(VkPhysicalDevice _physical, VkDevice _logical)
{
	physical = _physical;
	logical = _logical;
}
...
QueueFamilyIndices Device::getQueueFamilyIndices(VkSurfaceKHR surface)
{
